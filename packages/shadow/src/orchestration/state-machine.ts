...
const allowedTransitions: Record<RunState, RunState[]> = {
  ...
  // AWAITING_APPROVAL is reachable from PLANNED because the model-backed Plan stage
  // runs while the run is still PLANNED, and its provider call can require approval.
  PLANNED: ["EXECUTING", "TESTING", "VALIDATING", "AWAITING_APPROVAL", "DEPLOYING", "DOCUMENTING", "COMPLETED", "FAILED", "CANCELLED"],
  ...
  DEPLOYING: ["AWAITING_APPROVAL", "DOCUMENTING", "COMPLETED", "FAILED", "CANCELLED"],
